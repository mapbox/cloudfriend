...
class Lambda {
  ...
  constructor(options) {
    ...
    const {
      ...
      LogPolicyUpdateReplacePolicy = 'Delete'
    } = options;
    ...
    this.Resources = {
      ...
      [`${LogicalName}ManagedLogPolicy`]: {
        Type: 'AWS::IAM::ManagedPolicy',
        Condition,
        DependsOn: (RoleArn) ? undefined : `${LogicalName}Role`,
        DeletionPolicy: LogPolicyDeletionPolicy,
        UpdateReplacePolicy: LogPolicyUpdateReplacePolicy,
        Properties: {
          ManagedPolicyName: `${LogicalName}-lambda-log-access`,
          Roles: [roleName],
          PolicyDocument: {
            Version: '2012-10-17',
            Statement: [
