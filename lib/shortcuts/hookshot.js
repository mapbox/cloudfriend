...
class Passthrough {
  ...
  * @param {string} options.Prefix this will be used to prefix the set of CloudFormation
  * resources created by this shortcut.
  * @param {string} options.PassthroughTo the logical name of the Lambda function that you
  * have written which will receive a request and generate a response to provide
  * to the caller.
  * @param {string} [options.LoggingLevel='OFF'] one of `OFF`, `INFO`, or `ERROR`. Logs are delivered
  * to a CloudWatch LogGroup named `API-Gateway-Execution-Logs_{rest-api-id}/hookshot`
  * @param {boolean} [options.DataTraceEnabled=false] set to `true` to enable full request/response
  * logging in the API's execution logs.
  * @param {boolean} [options.MetricsEnabled=false] set to `true` to enable additional
  * execution metrics in CloudWatch.
  * @param {string} [options.AccessLogFormat] A single line format of the access logs of
...
class Github extends Passthrough {
   ...
   * have written which will receive a request and generate a response to provide
   * to the caller.
   * @param {string} options.LoggingLevel one of `OFF`, `INFO`, or `ERROR`. Logs are delivered
   * to a CloudWatch LogGroup named `API-Gateway-Execution-Logs_{rest-api-id}/hookshot`
   *
   */
  constructor(options) {
