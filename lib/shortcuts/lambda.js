 ...
 * @param {Array<Object>} [options.Statement=[]] Policy statements that will be added to a generated IAM role defining the permissions your Lambda function needs to run.
 * @param {String} [options.RoleARN=undefined] If specified, the Lambda function will use this role instead of creating a new role.
