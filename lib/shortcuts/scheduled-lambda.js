 ...
 * @param {String} [options.RoleArn=undefined] If specified, the eventbride schedule will use this role to invoke your lambda . _If this option is specified, do not use the Statement option; add the permissions you need to your Role directly._
