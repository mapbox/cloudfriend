 ...
 */
pseudo.account = () => {
  return intrinsic.ref('AWS::AccountId');
};
 ...
 * current stack.
 */
pseudo.notificationArns = () => {
  return intrinsic.ref('AWS::NotificationARNs');
};
 ...
 */
pseudo.noValue = () => {
  return intrinsic.ref('AWS::NoValue');
};
 ...
 * @memberof cloudfriend
 * @name region
 * @returns  a string representing the AWS Region in which the encompassing
 * resource is being created, such as us-west-2.
 */
pseudo.region = () => {
  return intrinsic.ref('AWS::Region');
};
 ...
 */
pseudo.stackId = () => {
  return intrinsic.ref('AWS::StackId');
};
 ...
 */
pseudo.stack = () => {
  return intrinsic.ref('AWS::StackName');
};
