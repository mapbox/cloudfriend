 ...
 * @param {String} [options.InputFormat=undefined] the table's input format. See [AWS documenation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-table-storagedescriptor.html#cfn-glue-table-storagedescriptor-inputformat)
 * @param {String} [options.Location=''] the physical location of the table. See [AWS documenation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-table-storagedescriptor.html#cfn-glue-table-storagedescriptor-location)
 * @param {Number} [options.NumberOfBuckets=0] See [AWS documenation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-table-storagedescriptor.html#cfn-glue-table-storagedescriptor-numberofbuckets)
 * @param {String} [options.OutputFormat=undefined] the table's output format. See [AWS documenation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-table-storagedescriptor.html#cfn-glue-table-storagedescriptor-outputformat)
 * @param {Object} [options.StorageParameters=undefined] storage parameters. See [AWS documenation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-table-storagedescriptor.html#cfn-glue-table-storagedescriptor-parameters)
 * @param {Object} [options.SerdeInfo={}] the serialization/deserialization information. See [AWS documenation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-table-storagedescriptor.html#cfn-glue-table-storagedescriptor-serdeinfo)
 * @param {Object} [options.SkewedInfo=undefined] frequent value information. See [AWS documenation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-table-storagedescriptor.html#cfn-glue-table-storagedescriptor-skewedinfo)
 * @param {Array<Object>} [options.SortColumns=undefined] list specifying the sort order. See [AWS documenation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-table-storagedescriptor.html#cfn-glue-table-storagedescriptor-sortcolumns)
 * @param {Boolean} [options.StoredAsSubdirectories=true] See [AWS documenation](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-table-storagedescriptor.html#cfn-glue-table-storagedescriptor-storedasdubdirectories)
