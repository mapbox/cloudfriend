  ...
  constructor(options) {
    ...
    const Resources = {
      ...
      [`${Prefix}OptionsMethod`]: {
        ...
        Properties: {
          ...
          Integration: {
            ...
            Uri: {
              'Fn::Sub': `arn:aws:apigateway:\${AWS::Region}:lambda:path/2015-03-31/functions/\${${Prefix}Function.Arn}/invocations`,
            },
          },
        },
      },
      ...
      [`${Prefix}Permission`]: {
        ...
        Properties: {
          ...
          SourceArn: {
            'Fn::Sub': `arn:aws:execute-api:\${AWS::Region}:\${AWS::AccountId}:\${${Prefix}Api}/*`,
          },
        },
      },
    };
    ...
    if (AccessLogFormat) {
      Resources[`${Prefix}AccessLogs`] = {
        ...
        Properties: {
          LogGroupName: {
            'Fn::Sub': `\${AWS::StackName}-${Prefix}-access-logs`,
          },
          RetentionInDays: 14,
        },
      };
      ...
      Resources[
        `${Prefix}Stage`
      ].Properties.MethodSettings[0].AccessLogSetting = {
    ...
    this.Outputs = {
      [`${Prefix}EndpointOutput`]: {
        ...
        Value: {
          'Fn::Sub': `https://\${${Prefix}Api}.execute-api.\${AWS::Region}.amazonaws.com/hookshot/webhook`,
        },
      },

      [`${Prefix}SecretOutput`]: {
        Description:
          'A secret key to give Github to use when signing webhook requests',
    ...
    return {
      ...
      Properties: {
        ...
        Integration: {
          ...
          IntegrationHttpMethod: 'POST',
          Uri: {
            'Fn::Sub': `arn:aws:apigateway:\${AWS::Region}:lambda:path/2015-03-31/functions/\${${this.Prefix}Function.Arn}/invocations`,
          },
        },
      },
    };
    ...
    return {
      ...
      Properties: {
        ...
        Integration: {
          ...
          RequestTemplates: {
            'application/json':
              '{"signature":"$input.params(\'X-Hub-Signature\')","body":$input.json(\'$\')}',
          },
        },
        MethodResponses: [
          {
