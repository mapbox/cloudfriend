 ...
 * @param {String} [options.TopicArn] Specify an SNS topic ARN to subscribe the queue to.
...
class Queue {
  constructor(options = {}) {
    ...
    let subscribedTopicArn = TopicArn;
    if (!subscribedTopicArn) {
      ...
      subscribedTopicArn = { Ref: `${LogicalName}Topic` };
    }
          ...
          Statement: [
            {
              ...
              Condition: {
                ArnEquals: {
                  'aws:SourceArn': subscribedTopicArn
                }
              }
            }
          ]
