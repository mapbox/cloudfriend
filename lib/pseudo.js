 ...
 * @name accountId
 */
const accountId = intrinsic.ref('AWS::AccountId');
 ...
 */
const notificationArns = intrinsic.ref('AWS::NotificationARNs');
 ...
 * @name noValue
 */
const noValue = intrinsic.ref('AWS::NoValue');
 ...
 * @name region
 */
const region = intrinsic.ref('AWS::Region');
 ...
 * @name stackId
 */
const stackId = intrinsic.ref('AWS::StackId');
 ...
 * @name stackName
 */
const stackName = intrinsic.ref('AWS::StackName');
 ...
 * @name partition
 */
const partition = intrinsic.ref('AWS::Partition');
 ...
 * @name urlSuffix
 */
const urlSuffix = intrinsic.ref('AWS::URLSuffix');

module.exports = { accountId, notificationArns, noValue, region, stackId, stackName, partition, urlSuffix };
